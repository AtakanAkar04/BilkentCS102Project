...
public class ContactController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        staffs.add(new StaffContact("Uğur Güdükbay", "EA", "Prof", "CS", "gudukbay@cs.bilkent.edu.tr", ugurGudukbay));
        staffs.add(new StaffContact("Lori Russel Dağ", "EA", "Instructor", "CS", "lori@bilkent.edu.tr", loriDag));
        staffs.add(new StaffContact("Uğur Doğrusöz", "EA", "Prof", "CS", "dogrusoz@cs.bilkent.edu.tr", ugurDogrusoz));
        staffs.add(new StaffContact("Can Alkan", "EA", "Assoc", "CS", "calkan@cs.bilkent.edu.tr", calkan));
